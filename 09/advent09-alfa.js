  ...
  runOperation()
  {
    ...
    switch (this.currentOperand)
    {
      ...
      case 5:
        ...
        log = this.opCodes[this.currentOperand].label+" - V: "+this.value[0]+" [J: "+jump+" - "+this.value[1]+"] }} "+this.index;
        break;
      case 6:
        if (this.value[0]===0)
        {
      ...
      case 7:
        ...
        this.memBank[this.address[2]] = result;
        log = this.opCodes[this.currentOperand].label+" - [FL: "+result+" - "+this.value[0]+"<"+this.value[1]+"] > ("+this.address[2]+")";
        break;
      case 8:
        result = (this.value[0] === this.value[1])?1:0;
        if (this.address[2] > this.memBank.length)
